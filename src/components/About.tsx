        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <div className="w-2 h-16 bg-gradient-primary rounded-full"></div>
          ...
          <div className="relative">
            <div className="bg-gradient-primary p-1 rounded-2xl shadow-elegant">
              <img 
            ...
            <div className="absolute -bottom-6 -right-6 bg-gold text-gold-foreground p-4 rounded-xl shadow-gold">
              <p className="font-bold text-2xl">92%</p>
              <p className="text-sm">Recommandent notre église</p>
            </div>
          </div>
        </div>
